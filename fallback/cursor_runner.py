...
Extracted verbatim from ``cursor-cli-purple/src/cursor_runner.py``. State across
iterations lives in workspace files (notably ``feedback.json``), matching the CLI's
